 ...
 * @generated
 */
public class UISUTDiagramEditorUtil {
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							Messages.UISUTDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS.bind(
									Messages.UISUTDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
									fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = UISUTDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				editingDomain,
				Messages.UISUTDiagramEditorUtil_CreateDiagramCommandLabel,
			...
			protected CommandResult doExecuteWithResult(
				...
				try {
					modelResource
							.save(name.niu.guita.uisut.diagram.part.UISUTDiagramEditorUtil
									.getSaveOptions());
					diagramResource
							.save(name.niu.guita.uisut.diagram.part.UISUTDiagramEditorUtil
									.getSaveOptions());
	 ...
	 * @generated
	 */
	private static UIStatemachine createInitialModel() {
		return name.niu.guita.uisut.uisutFactory.eINSTANCE
	 ...
	 * @generated
	 */
	private static void attachModelToResource(UIStatemachine model,
			Resource resource) {
