...
import name.niu.guita.uisut.diagram.edit.policies.FinalStateItemSemanticEditPolicy;
...
public class FinalStateEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof UIStateEditPart) {
			types.add(UISUTElementTypes.UITransition_4001);
		}
		if (targetEditPart instanceof InitialStateEditPart) {
			types.add(UISUTElementTypes.UITransition_4001);
		}
		if (targetEditPart instanceof name.niu.guita.uisut.diagram.edit.parts.FinalStateEditPart) {
			types.add(UISUTElementTypes.UITransition_4001);
		}
		return types;
	}
	...
	public class FinalStateFigure extends Ellipse {
		...
		private void createContents() {
			...
			elli0.setOutline(false);
			elli0.setBackgroundColor(ELLI0_BACK);
			elli0.setLocation(new Point(getMapMode().DPtoLP(5), getMapMode()
					.DPtoLP(5)));
	 ...
	 * @generated
	 */
	static final Color ELLI0_BACK = new Color(null, 32, 32, 32);
