...
import name.niu.guita.uisut.diagram.edit.policies.InitialStateItemSemanticEditPolicy;
...
public class InitialStateEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof name.niu.guita.uisut.diagram.edit.parts.InitialStateEditPart) {
			types.add(UISUTElementTypes.UITransition_4001);
		}
