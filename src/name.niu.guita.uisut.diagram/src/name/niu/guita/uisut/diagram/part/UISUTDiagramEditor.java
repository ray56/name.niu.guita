...
public class UISUTDiagramEditor extends DiagramDocumentEditor {
	 ...
	 * @generated
	 */
	public static final String ID = "name.niu.guita.uisut.diagram.part.UISUTDiagramEditorID"; //$NON-NLS-1$

	/**
	 * @generated
	 */
	public static final String CONTEXT_ID = "name.niu.guita.uisut.diagram.ui.diagramContext"; //$NON-NLS-1$
