...
/**
 * This is the item provider adapter for a {@link name.niu.guita.uitf.uitf.Statement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StatementItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Statement_itsVariable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Statement_itsVariable_feature", "_UI_Statement_type"),
				 UitfPackage.Literals.STATEMENT__ITS_VARIABLE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Statement_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Statement_description_feature", "_UI_Statement_type"),
				 UitfPackage.Literals.STATEMENT__DESCRIPTION,
				 true,
				 false,
				 false,
	...
	protected void addKindPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Statement_kind_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Statement_kind_feature", "_UI_Statement_type"),
				 UitfPackage.Literals.STATEMENT__KIND,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Statement)object).getDescription();
