...
/**
 * This is the item provider adapter for a {@link name.niu.guita.uitf.uitf.TestSuite} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TestSuiteItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TestSuite_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TestSuite_id_feature", "_UI_TestSuite_type"),
				 UitfPackage.Literals.TEST_SUITE__ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UitfPackage.Literals.TEST_SUITE__ITS_TEST_CASE);
		}
	...
	public String getText(Object object) {
		String label = ((TestSuite)object).getId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UitfPackage.Literals.TEST_SUITE__ITS_TEST_CASE,
				 UitfFactory.eINSTANCE.createTestCase()));
	}
