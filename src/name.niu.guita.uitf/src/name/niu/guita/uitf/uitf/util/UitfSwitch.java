...
public class UitfSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UitfPackage.TEST_CASE: {
				TestCase testCase = (TestCase)theEObject;
				T result = caseTestCase(testCase);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UitfPackage.TEST_SUITE: {
				TestSuite testSuite = (TestSuite)theEObject;
				T result = caseTestSuite(testSuite);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UitfPackage.VARIABLE: {
				Variable variable = (Variable)theEObject;
				T result = caseVariable(variable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UitfPackage.UISUT: {
				UISUT uisut = (UISUT)theEObject;
				T result = caseUISUT(uisut);
				if (result == null) result = caseVariable(uisut);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UitfPackage.UI_CONTROL_VARIABLE: {
				UIControlVariable uiControlVariable = (UIControlVariable)theEObject;
				T result = caseUIControlVariable(uiControlVariable);
				if (result == null) result = caseVariable(uiControlVariable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UitfPackage.STATEMENT: {
				Statement statement = (Statement)theEObject;
				T result = caseStatement(statement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UitfPackage.UI_CONTROL: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>UI Control Variable</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>UI Control Variable</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseUIControlVariable(UIControlVariable object) {
		return null;
	}
