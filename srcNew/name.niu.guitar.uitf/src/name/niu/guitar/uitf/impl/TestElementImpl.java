 ...
 * <ul>
 *   <li>{@link name.niu.guitar.uitf.impl.TestElementImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TestElementImpl extends EObjectImpl implements TestElement {
	...
	protected EClass eStaticClass() {
		return UitfPackage.Literals.TEST_ELEMENT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UitfPackage.TEST_ELEMENT__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UitfPackage.TEST_ELEMENT__ID:
				return getId();
		}
