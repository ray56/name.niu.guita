	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UitfPackage.TEST_SUITE: {
				...
				if (result == null) result = caseTestElement(testSuite);
			...
			case UitfPackage.TEST_CASE: {
				...
				if (result == null) result = caseTestElement(testCase);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UitfPackage.STATEMENT: {
				...
				if (result == null) result = caseTestElement(statement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UitfPackage.TEST_ELEMENT: {
