...
public class UisutAdapterFactory extends AdapterFactoryImpl {
	...
	protected UisutSwitch<Adapter> modelSwitch =
		new UisutSwitch<Adapter>() {
			...
			@Override
			public Adapter caseStateshortcut(Stateshortcut object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link name.niu.guitar.uisut.Stateshortcut <em>Stateshortcut</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
