...
public class UIElementImpl extends EObjectImpl implements UIElement {
	...
	protected EClass eStaticClass() {
		return UisutPackage.Literals.UI_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UisutPackage.UI_ELEMENT__NAME, oldName, name));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UisutPackage.UI_ELEMENT__DESCRIPTION, oldDescription, description));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UisutPackage.UI_ELEMENT__ID, oldId, id));
	}
