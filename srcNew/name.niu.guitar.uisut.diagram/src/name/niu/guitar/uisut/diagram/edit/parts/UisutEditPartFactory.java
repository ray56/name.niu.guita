 ...
 * @generated
 */
public class UisutEditPartFactory implements EditPartFactory {
	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case UIStatemachineEditPart.VISUAL_ID:
				return new UIStatemachineEditPart(view);

			case CommonStateEditPart.VISUAL_ID:
				return new CommonStateEditPart(view);

			case CommonStateNameEditPart.VISUAL_ID:
				return new CommonStateNameEditPart(view);
			...
			case UIStatemachine2EditPart.VISUAL_ID:
				return new UIStatemachine2EditPart(view);
