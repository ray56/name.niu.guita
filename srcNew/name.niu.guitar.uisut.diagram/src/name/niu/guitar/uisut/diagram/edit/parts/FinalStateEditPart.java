...
import name.niu.guitar.uisut.diagram.edit.policies.FinalStateItemSemanticEditPolicy;
...
public class FinalStateEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new FinalStateFigureDescriptor();
	}

	/**
	 * @generated
	 */
	public FinalStateFigureDescriptor getPrimaryShape() {
		return (FinalStateFigureDescriptor) primaryShape;
	}
	...
	protected void handleNotificationEvent(Notification event) {
		...
		if (event.getNotifier() instanceof FinalState ) {
	 ...
	 * @generated
	 */
	public class FinalStateFigureDescriptor extends Ellipse {

		/**
		 * @generated
		 */
		public FinalStateFigureDescriptor() {
		...
		private void createContents() {
			...
			elli0.setLineWidth(3);
			elli0.setForegroundColor(ELLI0_FORE);
			elli0.setBackgroundColor(ELLI0_BACK);
			elli0.setPreferredSize(new Dimension(getMapMode().DPtoLP(12),
					getMapMode().DPtoLP(12)));

			GridData constraintElli0 = new GridData();
			constraintElli0.verticalAlignment = GridData.CENTER;
			constraintElli0.horizontalAlignment = GridData.CENTER;
			constraintElli0.horizontalIndent = 0;
			constraintElli0.horizontalSpan = 0;
			constraintElli0.verticalSpan = 0;
			constraintElli0.grabExcessHorizontalSpace = true;
			constraintElli0.grabExcessVerticalSpace = true;
			this.add(elli0, constraintElli0);

		}
		
		public void updateHighlightProperty() {
			FinalState finalState = ( FinalState ) ((View)FinalStateEditPart.this.getModel()).getElement() ;
			String hightlintSyle = finalState.getHighlight() ;
	 ...
	 * @generated
	 */
	static final Color ELLI0_FORE = new Color(null, 255, 255, 255);

	/**
	 * @generated
	 */
	static final Color ELLI0_BACK = new Color(null, 0, 0, 0);
