...
import name.niu.guitar.uisut.diagram.edit.commands.UisutCreateShortcutDecorationsCommand;
...
public class ShortcutCreationWizard extends Wizard {
	...
	public boolean performFinish() {
		...
		command = command.compose(new UisutCreateShortcutDecorationsCommand(
