 ...
 * @generated
 */
public class UisutShortcutsDecoratorProvider extends AbstractProvider implements
		IDecoratorProvider {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& UIStatemachineEditPart.MODEL_ID.equals(UisutVisualIDRegistry
						.getModelID(view));
	}
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		public void refresh() {
			...
			EditPart editPart = (EditPart) getDecoratorTarget().getAdapter(
					EditPart.class);
			Image image = UisutDiagramEditorPlugin.getInstance()
