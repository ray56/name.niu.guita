...
public class UisutViewProvider extends AbstractProvider implements
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case CommonStateEditPart.VISUAL_ID:
			return createCommonState_2001(domainElement, containerView, index,
	 ...
	 * @generated
	 */
	public Node createCommonState_2001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(UisutVisualIDRegistry
				.getType(CommonStateEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createUIStatemachine_2004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(UisutVisualIDRegistry
				.getType(UIStatemachine2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
