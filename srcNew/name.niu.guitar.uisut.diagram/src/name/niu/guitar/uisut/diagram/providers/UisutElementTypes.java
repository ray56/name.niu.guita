...
public class UisutElementTypes {
	 ...
	 * @generated
	 */
	public static final IElementType UIStatemachine_1000 = getElementType("name.niu.guitar.uisut.diagram.UIStatemachine_1000"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public static final IElementType UITransition_4001 = getElementType("name.niu.guitar.uisut.diagram.UITransition_4001"); //$NON-NLS-1$
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(CommonState_2001,
					UisutPackage.eINSTANCE.getCommonState());

			elements.put(InitialState_2002,
					UisutPackage.eINSTANCE.getInitialState());

			elements.put(FinalState_2003,
					UisutPackage.eINSTANCE.getFinalState());
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(CommonState_2001);
